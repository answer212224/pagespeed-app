...
class ProcessMobileWebsite
{
    ...
    public function handle()
    {
        ...
        $response = Http::get('https://www.googleapis.com/pagespeedonline/v5/runPagespeed?url=' . $this->website->url . "&locale=zh-TW&strategy=mobile")->json();
